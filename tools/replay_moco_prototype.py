...
slips=[abs(c['surface_velocity_mps'][0]) for r in dense for c in r['contacts'] if c['force_N'][1]>.05*bw]
clearance={}
...
report={"schema":"eonwild.motion.moco-replay.v1","optimizer":solve,
    ...
    "limits":"Coarse discretization, estimated inertias/contact/strength, planar dynamics, no muscles, bone stress, lateral balance or biological validation"}
