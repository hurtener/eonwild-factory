# Eonwild Procedural Animation Toolkit — V1 through V5.5

This is the complete reproducible toolkit used to build and validate the Tarbosaurus V5.5 animation pack. It was duplicated from V5 so balance and posture can evolve without modifying the frozen V5 repository directory.

## Start here

- `validated_result/v5.5/tarbosaurus_procedural_v5_5_animation_pack.glb` — final V5.5 animation pack.
- `validated_result/v5.5/v5.5-release-validation.json` — balance, structure, jaw and transition validation.
- `toolkit/v5.5/README.md` — V5.5 corrections and reproduction instructions.
...
toolkit/v5.5/ full constrained regeneration with balance, support, walk, attack and feeding corrections
```

V1–V5 remain available as regression baselines. V5.5 does not destroy or overwrite any earlier version.
