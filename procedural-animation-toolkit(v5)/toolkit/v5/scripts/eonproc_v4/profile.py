...
class BipedV4Profile(BipedV3Profile):
    ...
    body_lean_deg: float = -2.8
    pelvis_neutral_pitch_deg: float = -0.35
    neck_relaxed_pitch_deg: float = -1.35
    head_horizon_pitch_deg: float = -0.45
    ...
    eating_pelvis_back_hip_fraction: float = 0.035
    eating_knee_flex_deg: float = 5.0
    ...
    bite_lunge_hip_fraction: float = 0.30
    bite_body_crouch_deg: float = 6.0
