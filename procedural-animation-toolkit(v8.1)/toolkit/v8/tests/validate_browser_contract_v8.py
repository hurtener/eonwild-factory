...
def main() -> int:
    ...
    mhash=re.search(r'window\.__EONWILD_V8_GLB_SHA256="([0-9a-f]{64})"',html)
    mb64=re.search(r'window\.__EONWILD_V8_GLB_BASE64="([A-Za-z0-9+/=]+)"',html)
    ...
    checks={
        ...
        'manifest_clip_count_40':len(names)==40,
