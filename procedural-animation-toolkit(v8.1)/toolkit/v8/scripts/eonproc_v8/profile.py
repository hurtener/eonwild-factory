...
class BipedV8Profile(BipedV7Profile):
    name: str = "tarbosaurus_v8_1_balance_jaw_and_power_attack"

    # Accepted V5.5 neutral-chain correction. Locomotion remains V8; these
    # values primarily correct authored idle/action posture.
    body_lean_deg: float = -1.0
    pelvis_neutral_pitch_deg: float = -1.10
    neck_relaxed_pitch_deg: float = -0.60
    ...
    # V8.1 airborne power attack, deliberately distinct from grounded bite.
    power_duration_seconds: float = 2.80
    power_coil_start_fraction: float = 0.12
    power_coil_end_fraction: float = 0.27
    power_takeoff_fraction: float = 0.38
    power_apex_fraction: float = 0.415
    power_bite_contact_fraction: float = 0.440
    power_land_fraction: float = 0.450
    power_catch_fraction: float = 0.550
    power_arrest_end_fraction: float = 0.76
    power_preload_back_hip_fraction: float = 0.080
    power_preload_down_hip_fraction: float = 0.060
    power_root_rise_hip_fraction: float = 0.088
    power_forward_hip_fraction: float = 0.390
    power_sole_clearance_hip_fraction: float = 0.050
    power_landing_absorb_hip_fraction: float = 0.038
    power_launch_load: float = 0.72
    power_jaw_open_deg: float = 52.0
