/** Eonwild V7 runtime contracts: contact-safe transition queues and root-loop accumulation. */
export interface V7ClipMeta {
  name: string;
...
export function mustUseExactHandoff(clip: V7ClipMeta): boolean {
