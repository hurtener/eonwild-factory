...
Every successful non-promotion command writes only below the supplied external
...
- 19 tests passed in 18.747 seconds; zero failures or skips.
...
- The fixed-camera Blender render was 640x360 PNG, 192,975 bytes, SHA-256
  `e6ed5469d8a095b12c3ec073ecac2d710593861305ca91fb0d8f15f517089ebd`.
...
implementer, the artifact hash is approved, required validation/comparison
evidence exists, provenance is complete, and the destination does not exist.
...
- `compare` in this slice is a machine-readable technical comparison; it does
  not yet generate a browsable editorial review page or video comparison.
