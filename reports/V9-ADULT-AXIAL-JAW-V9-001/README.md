...
The [emitted jaw audit](emitted-jaw-audit.json), SHA-256 `12e9fa8c27663a751cadb4b90bb3f19b5bf427915c7a7794f0a8bf9748730e13`, reopens all 297 keys in both modes. Every non-jaw local channel and key time is byte-identical to the closed body-only diagnostic. Across the declared 72-vertex sample, the minimum head-carried quantile-bin gap is `3.426269 mm`; this is not a full-surface or per-tooth collision-clearance certificate. A world-up bin gap may become negative under head pitch and is retained as a descriptive value, not treated as a collision metric.
