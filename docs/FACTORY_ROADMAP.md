...
Artistic direction and current consumer review states are maintained in the principal Eonwild repository: [animation direction](../../eonwild/docs/ANIMATION_ART_DIRECTION.md) and [game movement tracker](../../eonwild/docs/IMPLEMENTATION_ROADMAP.md). Resolve these against the principal repositories when working in an isolated checkout.
...
ye| Faster walking | Sequence approved | Sequence approved | 1.35× cadence, still grounded; not running |
