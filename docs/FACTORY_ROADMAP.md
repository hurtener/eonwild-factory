...
Current checkpoint: **C51 A visually approved; full Moco convergence remains unresolved.**
...
C51 A is rendered: ankle swing peak 90.85 degrees / 436.57 deg/s, skin intrusion 6.11 mm. All 288 side/quarter/front frames were inspected. Physical limitations remain (including command excess and no sample below 0.05 BW); full-Moco work is separate and has now finished without convergence. C51 A is now visually approved. No convergence or forward-stability claim.
...
### C51 approval and proposed next checkpoint

User explicitly approved C51 on 2026-09-23. This approves candidate A's displayed
motion, not the unselected full-Moco iterate or physical acceptance. The separate
user-review receipt is in principal game evidence `candidate-a/USER_REVIEW.md`;
capture-time pending receipts remain historical.

Proposed C52, not started: diagnose the remaining full-Moco dynamics/contact
constraint errors, improve loaded-foot traction without losing C51's approved
recovery/body/tail character, and produce a bounded comparison. Retain physical
limits and acceptance tolerances. Check the loaded/unloaded gait timing rather
than assuming this clip has a true airborne phase. Then complete independent
forward replay (stage 3) and parameter/mesh sensitivity (stage 4), before
claiming a validated transferable Moco gait or expanding to another animal.
Allosaurus transfer uses the same mechanics with admitted anatomy/semantics.
