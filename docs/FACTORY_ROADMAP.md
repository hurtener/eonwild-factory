...
|---|---|---|
| A — turning | Gentle walking curves, tighter low-speed turns, alternating stepping turns in place | Source-driven diagnostic generated; First draft rejected for forward-fixed gaze and micro-jumping footwork; revised leading-foot turn plus head/neck lead exported and captured; user review pending |
